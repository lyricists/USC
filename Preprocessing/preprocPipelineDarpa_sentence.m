...
save([fpath,erase(name,'.eeg'),'_bst_preprocessed_sFiles.mat'],'sFiles','sFiles_notch','-v7.3');
save([fpath,erase(name,'.eeg'),'_bst_preprocessed_data_zscore_int.mat'],'Result','-v7.3');