...
% % Process: DC offset correction: [-199ms,-1ms]
...
save([path,erase(name,'.eeg'),'_bst_preprocessed_data_ref.mat'],'Result','-v7.3');
save([path,erase(name,'.eeg'),'_bst_preprocessed_sFiles_ref.mat'],'sFiles','sFiles_notch','-v7.3');
